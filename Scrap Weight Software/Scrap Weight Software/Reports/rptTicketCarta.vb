...
Public Class rptTicketCarta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Scrap_Weight_Software.rptTicketCarta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTicketCarta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketCarta = New rptTicketCarta()
        rpt.Site = Me.Site
        Return rpt
    End Function
