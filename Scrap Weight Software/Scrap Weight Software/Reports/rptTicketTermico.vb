...
Public Class rptTicketTermico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Scrap_Weight_Software.rptTicketTermico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTicketTermico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketTermico = New rptTicketTermico()
        rpt.Site = Me.Site
        Return rpt
    End Function
