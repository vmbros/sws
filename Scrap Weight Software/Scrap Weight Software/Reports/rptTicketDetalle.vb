...
Public Class rptTicketDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Scrap_Weight_Software.rptTicketDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTicketDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketDetalle = New rptTicketDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
