...
Public Class cXK3118K5
    ...
    Public Function getPeso() As Double
        ...
        strResult = strResult.Substring(strResult.IndexOf(ChrW(61)) + 1, 7) 'Se extrae el sub string desde el ASCII 61 '=' con un largo de 7: signo + 6 dígitos
