...
Public Class frmTransportistas
    ...
    Dim dt As DataTable
    Dim comando As String = "SELECT TransportistaRUT AS RUT, TransportistaNom AS Nombre FROM tTransportista"
    ...
    Private Sub frmTransportistas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        sda.Update(dt)
        frmTransportistas_Load(sender, e)
    End Sub
        ...
        If Not (Me.Owner Is Nothing) Then
            Try
                ...
                With dgvMaestro.CurrentRow
                    _formInterface.iText(.Cells("RUT").Value, .Cells("Nombre").Value, "Transportistas")
                    Me.Dispose()
                    Me.Close()
                End With
    ...
    Private Sub txtNombre_TextChanged(sender As Object, e As EventArgs) Handles txtNombre.TextChanged
        ...
        If txtNombre.Text = "" Then
            texto = comando
        Else
            texto = comando & " WHERE TransportistaNom LIKE '%" & txtNombre.Text & "%'"
        End If
        sda = New OleDbDataAdapter(texto, con)
        'sda = New OleDbDataAdapter(comando & " WHERE TransportistaNom LIKE '%" & txtNombre.Text & "%'", con)
        dt = New DataTable
        sda.Fill(dt)
        With dgvMaestro
            .DataSource = dt
